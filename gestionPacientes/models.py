...
class CasosFormacion(models.Model):
 ...
 #Con la clase CLASS se indica en que tabla de la BD se guardan la información de los modelos.
    class Meta:

        db_table = 'casos_formacion'  #Aqui se le da un nombre a la tabla que tu quieras.
...
class Medico(User):
    ...
    medical_ID = models.CharField(max_length=250, null=True )
...
class Investigador(User):
    ...
    investigation_ID = models.CharField(max_length=250, null=True)
