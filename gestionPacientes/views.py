...
from paciente.models import Paciente, Basal_rate, Bolus_type, Bolus_volume_delivered, Carb_input, Carb_ratio, \
    ...
    Siesta_resumen, Siesta, Suenio, Glucosa_freestyle, Evento_insulina_rapida, Evento_insulina_lenta, \
    Evento_carbohidratos, Calorias, Ritmo_cardiaco, Pasos
...
def enviar_correo(usuario, contrasenia):
    try:
        body = "Has sido registrado en config\n USUARIO: " + usuario + "\n CONTRASEÑA: " + contrasenia
        email = EmailMessage('Registro config', body, to=[usuario])
        email.send()
    except:
